...
CREATE DATABASE IF NOT EXISTS `event-mangement-system`;

-- Use the database
USE `event-mangement-system`;

-- Create the user and grant privileges
CREATE USER IF NOT EXISTS 'eventhub_user'@'localhost' IDENTIFIED BY 'eventhub_password';
GRANT ALL PRIVILEGES ON `event-mangement-system`.* TO 'eventhub_user'@'localhost';
FLUSH PRIVILEGES;
